# -*- coding: utf-8 -*-
"""
Created on Tue Apr 14 16:23:56 2020
...
def walk(f, d, numSteps):
    ...
    """Assumes: f a Field, d a Drunk in f, and numSteps an int >= 0.
       ...
       Returns the distance between the final location and the location at the start"""
    start = f.getLoc(d)
...
def simWalks(numSteps, numTrials, dClass):
    """Assumes numDteps an int >= 0, numTrials an int > 0,
       dClass a sunclass of Drunk.
...
def drunkTest(walkLengths, numTrials, dClass):
    """Assumes walkLengths a sequence of ints >= 0,
       ...
       run simWalks with numTrials walks and print result"""
